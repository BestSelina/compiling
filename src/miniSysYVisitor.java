...
public interface miniSysYVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#relExp0}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitRelExp0(miniSysYParser.RelExp0Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#eqExp0}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitEqExp0(miniSysYParser.EqExp0Context ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#lAndExp0}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLAndExp0(miniSysYParser.LAndExp0Context ctx);
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#lAndOp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLAndOp(miniSysYParser.LAndOpContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#lOrExp0}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLOrExp0(miniSysYParser.LOrExp0Context ctx);
	/**
	 * Visit a parse tree produced by {@link miniSysYParser#lOrOp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitLOrOp(miniSysYParser.LOrOpContext ctx);
	/**
